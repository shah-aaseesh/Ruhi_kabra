    ...
    <PageTransition>
      <section className="relative pt-24 pb-12 px-6 md:px-12 lg:px-24 overflow-hidden">
        ...
        <motion.div className="relative z-10">
          ...
          {/* Marquee */}
          <motion.div
            className="overflow-hidden mt-8 border-y border-border/10 py-2 w-[100vw] -ml-[calc(50vw-50%)]"
            initial={{ scaleX: 0, originX: 0 }}
            animate={{ scaleX: 1 }}
            transition={{ delay: 0.6, duration: 0.8 }}
          >
            <div className="animate-marquee whitespace-nowrap">
              <span className="font-cormorant text-xs text-muted-foreground/80 tracking-[0.3em] italic">
